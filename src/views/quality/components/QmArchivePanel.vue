<script setup>
/**
 * 验评任务 · 档案填报面板（填报向导第 2 步）
 * WBS+工序表格列表 → 表格填写页；保存时完成档案登记。
 */
...
const emit = defineEmits(['changed', 'viewModeChange'])
...
<template>
  <div class="archive-panel">
    <div v-if="viewMode === 'list'" class="archive-head">
