  ...
  <div class="qm-page page-card">
    ...
    <template v-else>
      <el-descriptions :column="2" border size="small" class="mb">
        ...
        <el-descriptions-item label="定样单号">{{ detail.sample_id || '无定样' }}</el-descriptions-item>
        ...
        <el-descriptions-item label="进场数量">{{ detail.quantity }}{{ detail.unit }}</el-descriptions-item>
        ...
        <el-descriptions-item label="办结时间" :span="2">{{ detail.finish_time || '—' }}</el-descriptions-item>
      </el-descriptions>
