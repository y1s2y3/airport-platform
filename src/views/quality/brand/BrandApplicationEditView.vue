...
import { Plus, Delete, Document, Box, CollectionTag } from '@element-plus/icons-vue'
    ...
    <el-form label-width="128px" class="create-form" label-position="right">
      ...
      <section class="form-section">
        <header class="section-head">
          ...
          <div>
            ...
            <p class="section-desc">可从材料库导入，或手填材料名称与类型</p>
          </div>
        </header>
        ...
        <div class="section-body">
          ...
          <div class="field-grid">
            ...
            <el-form-item label="使用部位">
              <el-input v-model="form.use_part" placeholder="非必填" clearable />
            </el-form-item>
          </div>
        </div>
      </section>
        ...
        <header class="section-head">
          ...
          <div class="section-head-main">
            <div class="section-title-row">
              <h2 class="section-title">本单规格</h2>
          ...
          <el-button v-if="!imported" type="primary" link :icon="Plus" @click="addSpec">
            添加规格
          </el-button>
        </header>
      ...
      <section class="form-section">
        <header class="section-head">
          ...
          <el-button type="primary" link :icon="Plus" @click="addCandidate">添加备选</el-button>
        </header>
