...
const list = computed(() => {
  ...
  return formTemplates.filter((t) => `${t.template_code}${t.template_name}${t.standard_ref || ''}`.includes(kw))
})
...
<template>
  <div class="qm-page page-card">
    <div class="page-header">
      <div class="page-breadcrumb">档案管理 / 省统表管理</div>
      <h1 class="page-title">省统表管理</h1>
      <p class="page-tip">
        维护省统表预置及项目自建验收表单模板；启用后可被检验批类型与验评节点引用
      </p>
    </div>
    <div class="filter-bar">
      <el-input v-model="keyword" clearable placeholder="编码/名称/标准依据" style="width: 240px" :prefix-icon="Search" />
    ...
    >
      ...
      <el-table-column prop="standard_ref" label="标准依据" min-width="140" show-overflow-tooltip />
    ...
    <el-dialog v-model="visible" :title="form.id ? '编辑模板' : '新建模板'" width="560px">
      <el-form label-width="110px">
        ...
        <el-form-item label="标准依据"><el-input v-model="form.standard_ref" placeholder="如 省统表·钢筋检验批" /></el-form-item>
