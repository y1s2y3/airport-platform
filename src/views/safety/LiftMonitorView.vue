...
function goBackToHQ() {
  ...
  router.push('/machine-supervise/lift')
}
...
{ project_name:'飞行区跑道延长工程', project_id:'p-000', deviceCount:1, onlineCount:1, alertCount:2, todayAlertCount:1, pendingAlertCount:1 },
    { project_name:'新货运站建设工程', project_id:'p-003', deviceCount:1, onlineCount:0, alertCount:1, todayAlertCount:0, pendingAlertCount:1 }
])
...
function viewProjectDetail(row) {
  router.push({ path: '/machine-supervise/lift', query: { from: 'hq' } }).then(() => {
...
<template>
  <div class="eq-page">
    <div class="page-head"><h3 class="page-title">升降机运行监管</h3></div>
    ...
    <template v-if="!isHqSelected">
      ...
      <el-table :data="filteredData" stripe border style="width:100%" class="data-table">
        ...
        <el-table-column prop="deviceName" label="设备名称" align="center" />
            ...
            <el-table-column prop="persons" label="人数" align="center" />
