...
const d = {
  // ===== 待整改·一次 =====
  'rec-001': {
    rn:'ZG202607001', tn:'XJ20260728001', pj:'飞行区跑道延长工程', rf:'赵工', rv:'张工', dl:'2026-07-30', st:'待整改',
  ...
  // ===== 待复查·一次 =====
  'rec-002': {
    rn:'ZG202607002', tn:'XJ20260728001', pj:'飞行区跑道延长工程', rf:'李工', rv:'张工', dl:'2026-07-28', st:'待复查',
    hazard:{ desc:'五芯电缆破损，线路未按规范敷设', photos:['📷 隐患照片1'] },
