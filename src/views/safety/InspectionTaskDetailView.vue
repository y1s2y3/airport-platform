...
// ===== 5条任务基本信息 =====
const taskMap = {
  'mt-000': { taskNo:'AQXJ20260730001', planName:'6月底安全巡检', planNo:'AQXJ20260630001', planType:'周检', inspectionCategory:'安全', source:'任务推送', project:'飞行区跑道延长工程', projectId:'p-000', executor:'监理', inspector:'监理', companions:[], deadline:'2026-07-10', inspectionDate:'', status:'待执行', itemCount:10, hazardCount:0, result:'', normalPhotos:[], hazardItems:[] },
  'mt-001': { taskNo:'AQXJ20260728001', planName:'7月第4周安全巡检', planNo:'AQXJ20260719001', planType:'周检', inspectionCategory:'安全', source:'任务推送', project:'飞行区跑道延长工程', projectId:'p-000', executor:'监理', inspector:'监理', companions:[], deadline:'2026-07-28', inspectionDate:'', status:'待执行', itemCount:12, hazardCount:0, result:'', normalPhotos:[], hazardItems:[] },
  'mt-002': { taskNo:'AQXJ20260720002', planName:'临时用电专项检查', planNo:'AQXJ20260718001', planType:'专项巡检', inspectionCategory:'安全', source:'任务推送', project:'T3航站楼扩建工程', projectId:'p-001', executor:'监理', inspector:'监理', companions:[], deadline:'2026-07-20', inspectionDate:'2026-07-20', status:'已完成', itemCount:8, hazardCount:2, result:'hazard', normalPhotos:[],
    hazardItems:[
  ...
  'mt-003': { taskNo:'AQXJ20260721003', planName:'7月第三周安全巡检', planNo:'AQXJ20260714001', planType:'周检', inspectionCategory:'安全', source:'任务推送', project:'T3航站楼扩建工程', projectId:'p-001', executor:'监理', inspector:'监理', companions:[], deadline:'2026-07-21', inspectionDate:'2026-07-21', status:'已完成', itemCount:12, hazardCount:0, result:'normal', normalPhotos:['📷 巡检照片1','📷 巡检照片2'], hazardItems:[] },
  'mt-004': { taskNo:'ZLXJ20260731004', planName:'', planNo:'', planType:'月检', inspectionCategory:'质量', source:'系统自建', project:'新货运站建设工程', executor:'王工', inspector:'王工', companions:[], deadline:'', inspectionDate:'2026-07-31', status:'已完成', itemCount:0, hazardCount:0, result:'normal', normalPhotos:['📷 巡检照片1','📷 巡检照片2'], hazardItems:[] },
  'mt-005': { taskNo:'ZLXJ20260728005', planName:'', planNo:'', planType:'专项巡检', inspectionCategory:'质量', source:'系统自建', project:'飞行区跑道延长工程', executor:'王工', inspector:'王工', companions:['吴工'], deadline:'', inspectionDate:'2026-07-28', status:'已完成', itemCount:0, hazardCount:1, result:'hazard', normalPhotos:[],
    hazardItems:[
