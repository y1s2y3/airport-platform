...
function goBackToHQ() {
  ...
  router.push('/machine-supervise/pile')
}
...
function viewProjectDetail(row) {
  ...
  router.push({ path: '/machine-supervise/pile', query: { from: 'hq' } })
}
</script>

<template>
  <div class="eq-page">
    <div class="page-head"><h3 class="page-title">桩基运行监管</h3></div>
    ...
    <template v-if="!isHqSelected">
      ...
      <el-table :data="filteredData" stripe border style="width:100%" class="data-table">
        ...
        <el-table-column prop="deviceName" label="设备名称" align="center" />
            ...
            <el-table-column prop="tilt" label="倾角(°)" align="center" />
