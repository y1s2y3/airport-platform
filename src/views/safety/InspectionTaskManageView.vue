...
const taskData = ref([
  {
    id:'mt-000', taskNo:'AQXJ20260730001', planNo:'JH2026007', source:'任务推送',
    planName:'6月底安全巡检', planType:'周检', inspectionCategory:'安全',
  ...
  {
    id:'mt-001', taskNo:'AQXJ20260728001', planNo:'JH2026001', source:'任务推送',
    planName:'7月第4周安全巡检', planType:'周检', inspectionCategory:'安全',
    project:'飞行区跑道延长工程', projectId:'p-000',
    inspector:getProjectInspectorLabel('p-000'), companions:[],
  ...
  {
    id:'mt-002', taskNo:'AQXJ20260720002', planNo:'JH2026002', source:'任务推送',
    planName:'临时用电专项检查', planType:'专项巡检', inspectionCategory:'安全',
  ...
  {
    id:'mt-003', taskNo:'AQXJ20260721003', planNo:'JH2026001', source:'任务推送',
    planName:'7月第三周安全巡检', planType:'周检', inspectionCategory:'安全',
    project:'T3航站楼扩建工程', projectId:'p-001',
    inspector:getProjectInspectorLabel('p-001'), companions:[],
  ...
  {
    id:'mt-004', taskNo:'ZLXJ20260731004', planNo:'', source:'系统自建',
    planName:'', planType:'月检', inspectionCategory:'质量',
    project:'新货运站建设工程', projectId:'p-003',
    inspector:DEFAULT_INSPECTOR_LABEL, companions:[],
    deadline:'', inspectionDate:'2026-07-31', status:'已完成',
    itemCount:0, hazardCount:0, hazardItems:[],
  },
  {
    id:'mt-005', taskNo:'ZLXJ20260728005', planNo:'', source:'系统自建',
    planName:'', planType:'专项巡检', inspectionCategory:'质量',
    project:'飞行区跑道延长工程', projectId:'p-000',
    inspector:DEFAULT_INSPECTOR_LABEL, companions:['吴工'],
...
// ===== 筛选 =====
const filterForm = reactive({ keyword: '', category: '', status: '', source: '', planType: '', result: '', overdue: '' })
