...
{ projectName:'T3航站楼扩建工程', projectId:'p-001', deviceCount:1, onlineCount:1, alertCount:2, todayAlertCount:1, pendingAlertCount:1 },
    { projectName:'飞行区跑道延长工程', projectId:'p-000', deviceCount:1, onlineCount:0, alertCount:1, todayAlertCount:0, pendingAlertCount:1 }
])
