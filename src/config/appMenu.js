...
export const appMenu = [
  { key: 'app-workbench', label: '首页', icon: 'HomeFilled', levels: 'both' },
  {
    key: 'app-jg-app',
    label: '建管APP',
    icon: 'Cellphone',
    ...
    children: [
      ...
      { key: 'app-jg-biz', label: '业务功能', icon: 'Briefcase', levels: 'project' },
  ...
  },
  {
    ...
    levels: 'both',
    children: [
      { key: 'app-labor-dashboard', label: '人员实名制看板', icon: 'Odometer', levels: 'both' },
      { key: 'app-labor-realname', label: '人员实名制', icon: 'Postcard', levels: 'both' },
      { key: 'app-labor-warning', label: '预警清单', icon: 'Notification', levels: 'both' },
  ...
  },
  {
    ...
    levels: 'both',
    children: [
      { key: 'app-vehicle-dashboard', label: '车辆管理看板', icon: 'PieChart', levels: 'both' },
      { key: 'app-vehicle-access', label: '进出场记录', icon: 'Switch', levels: 'project' },
      { key: 'app-vehicle-warning', label: '预警清单', icon: 'Notification', levels: 'project' },
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'app-mobile-message-center', label: '消息中心(移动端)', icon: 'ChatDotRound', levels: 'both' },
  ...
  },
  {
    ...
    levels: 'project',
    children: [
      { key: 'app-major-hazard-dictionary', label: '危大字典配置', icon: 'Collection', levels: 'project' },
  ...
  },
  {
    ...
    levels: 'both',
    children: [
      { key: 'app-coc-daily-work', label: '每日施工作业', icon: 'Sunny', levels: 'both' },
      { key: 'app-coc-notice', label: '任务单', icon: 'Tickets', levels: 'both' },
      { key: 'app-coc-penalty', label: '处罚单', icon: 'Stamp', levels: 'both' },
    ],
  },
  {
    key: 'app-mat-entry',
