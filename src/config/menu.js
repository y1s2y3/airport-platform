...
export const menuTree = [
  ...
  /** 指挥部 · 质量看板 */
  {
    ...
    children: [
      ...
      { key: 'brand-approval-stats', label: '品牌报审', icon: 'CollectionTag', path: '/qm/quality-board/brand-stats', name: 'BrandApprovalStats', component: 'BrandApprovalStatsView', levels: 'hq' },
      ...
      { key: 'mat-dashboard', label: '材料设备进场', icon: 'ShoppingBag', path: '/qm/mat/dashboard', name: 'MatDashboard', component: 'MatDashboardView', levels: 'hq' },
    ],
  },

  /** 智慧工地监管（两级共用，子项按 levels 区分） */
  {
    key: 'smart-site', label: '智慧工地监管', icon: 'Monitor', levels: 'both',
    children: [
      {
        key: 'labor', label: '人员实名制管理', icon: 'User', levels: 'both',
        children: [
          { key: 'labor-realname-stats', label: '实名制统计', icon: 'DataLine', path: '/labor/realname-stats', name: 'LaborRealNameStats', component: 'LaborRealNameStatsView', levels: 'hq', sortByLevel: { hq: 0 } },
          ...
          { key: 'labor-blacklist', label: '劳务黑名单', icon: 'CircleClose', path: '/labor/blacklist', name: 'LaborBlacklist', component: 'LaborBlacklistView', levels: 'hq', sortByLevel: { hq: 3 } },
          { key: 'labor-dashboard', label: '人员实名制看板', icon: 'Compass', path: '/labor/dashboard', name: 'LaborDashboard', component: 'LaborDashboardView', levels: 'project', sortByLevel: { project: 2 } },
          { key: 'labor-realname', label: '人员实名制', icon: 'Document', path: '/labor/realname', name: 'RealNamePersonnel', component: 'RealNamePersonnelView', levels: 'project', sortByLevel: { project: 3 } },
          ...
          { key: 'labor-warning-list', label: '预警清单', icon: 'Bell', path: '/labor/warning-list', name: 'LaborWarningList', component: 'LaborWarningListView', levels: 'project', sortByLevel: { project: 6 } },
      ...
      },
      {
        ...
        children: [
          { key: 'vehicle-dashboard', label: '车辆管理看板', icon: 'DataAnalysis', path: '/vehicle/dashboard', name: 'VehicleDashboard', component: 'VehicleDashboardView', levels: 'hq' },
          ...
          { key: 'vehicle-track', label: '车辆轨迹监管', icon: 'Location', path: '/vehicle/track', name: 'VehicleTrack', component: 'VehicleTrackView', levels: 'project' },
        ],
      },
      {
        key: 'machine-supervise', label: '机械设备监管', icon: 'SetUp', levels: 'both',
        children: [
          { key: 'device-manage', label: '监测设备管理', icon: 'SetUp', path: '/machine-supervise/device', name: 'DeviceManage', component: 'DeviceManageView', levels: 'project' },
          { key: 'crane-monitor', label: '塔吊运行监管', icon: 'Rank', path: '/machine-supervise/crane', name: 'CraneMonitor', component: 'CraneMonitorView', levels: 'both' },
          ...
          { key: 'composite-monitor', label: '复合地基机械施工监管', icon: 'SetUp', path: '/machine-supervise/composite', name: 'CompositeMonitor', component: 'CompositeMonitorView', levels: 'both' },
      ...
      {
        key: 'major-hazard', label: '危大工程监测', icon: 'Warning', levels: 'both',
        children: [
          ...
          { key: 'subway-protection', label: '地铁铁路安全监管', icon: 'Van', path: '/major-hazard/subway-protection', name: 'SubwayProtection', component: 'SubwayProtectionView', levels: 'both' },
          { key: 'high-formwork', label: '高支模变形监管', icon: 'School', path: '/major-hazard/high-formwork', name: 'HighFormwork', component: 'HighFormworkView', levels: 'both' },
  ...
  /** 施工现场管理（两级共用） */
  {
    key: 'site-construction', label: '施工现场管理', icon: 'Position', levels: 'both',
    children: [
      {
        key: 'work-manage', label: '施工作业管理', labelByLevel: { hq: '施工作业管理', project: '施工作业申报' }, icon: 'Calendar', levels: 'both',
        children: [
          { key: 'major-hazard-daily-work', label: '每日施工作业', icon: 'Sunrise', path: '/major-hazard/daily-work', name: 'MajorHazardDailyWork', component: 'DailyWorkView', levels: 'both' },
      ...
      {
        key: 'risk-manage-group', label: '风险管理', icon: 'Compass', levels: 'project',
        children: [
      ...
      {
        key: 'major-hazard-management', label: '危大工程管理', icon: 'Warning', levels: 'project',
        children: [
          { key: 'major-hazard-dictionary', label: '危大字典配置', icon: 'Notebook', path: '/major-hazard/dictionary', name: 'MajorHazardDictionary', component: 'HazardDictionaryView', levels: 'project' },
      ...
      },
      {
        ...
        children: [
          { key: 'safety-plan', label: '任务下发', icon: 'Position', path: '/safety-inspection/plan', name: 'InspectionPlan', component: 'InspectionPlanView', levels: 'hq' },
          ...
          { key: 'safety-inspector-config', label: '人员配置', icon: 'User', path: '/safety-inspection/inspector-config', name: 'InspectionPersonConfig', component: 'InspectionPersonConfigView', levels: 'project' },
          ...
          { key: 'mobile-message-center', label: '消息中心(移动端)', icon: 'ChatLineRound', path: '/mobile/messages', name: 'MobileMessageCenter', component: 'MobileMessageCenterView', levels: 'both' },
      ...
      {
        key: 'machine-ledger', label: '机械设备台账', icon: 'Files', levels: 'project',
        children: [
  ...
  /** 施工质量管控（仅项目层级） */
  {
    key: 'construction-quality', label: '施工质量管控', icon: 'TrophyBase', levels: 'project',
    children: [
      {
        key: 'quality-inspect', label: '质量验评', icon: 'Tickets', levels: 'project',
        children: [
          ...
          { key: 'qm-special-deep', label: '专项验收', icon: 'Position', path: '/qm/inspect/special-deep', name: 'QmSpecialDeep', component: 'QmSpecialDeepView', levels: 'project' },
      ...
      {
        key: 'brand-approval', label: '品牌报审', icon: 'CollectionTag', levels: 'project',
        children: [
      ...
      {
        key: 'sample-mgmt', label: '样板管理', icon: 'Picture', levels: 'project',
        children: [
          { key: 'sample-ledger', label: '样板台账', icon: 'Picture', path: '/qm/sample/ledger', name: 'SampleLedger', component: 'SampleLedgerView', levels: 'project' },
          { key: 'sample-material-app', label: '定样审批', icon: 'CircleCheck', path: '/qm/sample/material/applications', name: 'SampleMaterialApp', component: 'SampleMaterialAppListView', levels: 'project' },
      ...
      {
        key: 'mat-entry-mgmt', label: '材料设备进场', icon: 'ShoppingBag', levels: 'project',
        children: [
          ...
          { key: 'mat-exit', label: '退场登记', icon: 'ShoppingCart', path: '/qm/mat/exit', name: 'MatExit', component: 'MatExitView', levels: 'project' },
      ...
      { key: 'asbuilt-list', label: '实模一致验收', icon: 'Crop', path: '/qm/asbuilt/list', name: 'AsbuiltList', component: 'AsbuiltListView', levels: 'project' },
    ],
  },
  ...
  /** AI 应用（仅项目层级） */
  {
    key: 'ai-app', label: 'AI 应用', icon: 'Camera', levels: 'project',
    children: [
      ...
      { key: 'ai-unsafe-behavior', label: '现场不安全行为检测', icon: 'CircleClose', path: '/ai-app/unsafe-behavior', name: 'AiUnsafeBehavior', component: 'AiUnsafeBehaviorView', levels: 'project' },
      ...
      { key: 'ai-drone-recognition', label: '无人机 AI 识别', icon: 'Compass', path: '/ai-app/drone-recognition', name: 'AiDroneRecognition', component: 'AiDroneRecognitionView', levels: 'project' },
    ],
  },
  ...
  /** 调度后台管理（两级共用，子项按 levels 区分） */
  {
    ...
    children: [
      ...
      { key: 'coc-admin-penalty', label: '处罚单', icon: 'Tickets', path: '/coc-admin/penalty', name: 'CocAdminPenalty', component: 'AdminDispatchPenaltyList', routeComponent: 'CocAdminPageView', levels: 'hq', roles: ['安质部', '项目经理', '施工'], description: '管理处罚单：新增、下发、编辑、关闭与纳入黑榜。' },
      { key: 'coc-admin-redblack', label: '黑红榜单', icon: 'TrophyBase', path: '/coc-admin/red-black', name: 'CocAdminRedBlack', component: 'AdminDispatchRedBlackList', routeComponent: 'CocAdminPageView', levels: 'hq', roles: ['安质部', '项目经理', '施工'], description: '维护项目红榜/黑榜展示。' },
      ...
      { key: 'coc-admin-dispatch-hazard', label: '调度隐患清单', icon: 'Notebook', path: '/coc-admin/dispatch-hazard', name: 'CocAdminDispatchHazard', component: 'DispatchHazardListView', routeComponent: 'CocAdminPageView', levels: 'both', roles: ['COC调度室', '安质部', '项目经理', '施工'], description: '汇集 COC 调度大屏问题截图登记的安全/质量隐患台账。' },
      { key: 'coc-admin-meeting-signin', label: '会议记录', icon: 'CircleCheck', path: '/coc-admin/meeting-signin', name: 'CocAdminMeetingSignIn', component: 'AdminMeetingSignInList', routeComponent: 'CocAdminPageView', levels: 'hq', roles: ['COC调度室'], description: '指挥部会议签到台账：会议时间、本次调度项目及各项目参会结束时的已参会人员清单。' },
    ],
  },

  /** 基础数据管理（两级共用，子项按 levels 区分） */
  {
    key: 'basic-data', label: '基础数据管理', icon: 'Notebook', levels: 'both',
    children: [
      { key: 'bd-project-info', label: '项目信息管理', icon: 'Monitor', path: '/basic-data/project/info', name: 'ProjectBasicInfo', component: 'ProjectBasicInfoView', levels: 'both' },
      { key: 'bd-subcontractor', label: '分包单位管理', labelByLevel: { hq: '分包单位管理', project: '分包单位报审' }, icon: 'SuitcaseLine', path: '/basic-data/project/subcontractor', name: 'SubcontractorList', component: 'SubcontractorListView', levels: 'both' },
  ...
  /** 组织管理（两级共用，菜单管理仅指挥部） */
  {
    ...
    children: [
      { key: 'sys-org', label: '组织架构', icon: 'Management', path: '/settings/org', name: 'SysOrg', component: 'OrgStructureView', levels: 'both' },
      ...
      { key: 'sys-menu', label: '菜单管理', icon: 'Operation', path: '/settings/menu', name: 'SysMenu', component: 'MenuManageView', levels: 'hq' },
    ],
  },
