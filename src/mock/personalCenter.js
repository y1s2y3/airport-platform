  ...
  return [
    ...
    },
    {
      ...
      detail: {
        ...
        brandLedgerId: 'BL-007',
        ledgerMaterialName: '砂浆',
        brandLedgerLabel: '海螺 · 安徽海螺水泥股份有限公司 · 砂浆',
        materialType: '材料',
        currentNode: '待监理审',
        briefing: '通体瓷砖 800×800；吸水率≤0.5%；耐磨等级 4 级；表面平整度≤0.5mm。',
        indicatorDesc: '通体瓷砖 800×800；吸水率≤0.5%；耐磨等级 4 级；表面平整度≤0.5mm。',
    ...
    },
    {
      ...
      detail: {
        ...
        brandLedgerId: 'BL-EQ-P001',
        ledgerMaterialName: '铝单板',
        brandLedgerLabel: '兴发 · 广东兴发铝业有限公司 · 铝单板',
        materialType: '设备',
        currentNode: '待项目经理审',
...
function buildSampleTodo(payload) {
  ...
  return {
    ...
    detail: {
      ...
      brandLedgerId: payload.brandLedgerId || '',
      ledgerMaterialName: payload.ledgerMaterialName || '',
      brandLedgerLabel: payload.brandLedgerLabel || '',
