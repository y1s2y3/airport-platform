...
import {
  ...
  seedSampleStartedFromApps,
  seedSampleDoneFromApps,
  upsertSampleStarted,
...
const store = reactive({
  ...
  materials: [
    ...
    },
    {
      ...
      remark: '演示：已驳回留档（已有重新申报单 MS-005）',
    },
    {
      application_id: 'MS-005',
      project_id: 'p-000',
      sample_name: '防水卷材',
      material_name: '防水卷材',
      material_type: 'material',
      ...
      sample_photos: [{ name: '防水卷材样板-补正.jpg', url: '#' }],
      effect_images: [{ name: '防水卷材样板-补正.jpg', url: '#' }],
      sign_files: [{ name: '材料设备送样定板报审签字.pdf', url: '#' }],
      approval_files: [{ name: '材料设备送样定板报审签字.pdf', url: '#' }],
      certificate_files: [{ name: '防水卷材出厂质量证明.pdf', url: '#' }],
      copy_from_application_id: 'MS-004',
      status: 'in_approval',
      current_node: 'supervisor',
      applicant_name: '施工-李工',
      submit_time: '2026-07-22 10:30:00',
      finish_time: '',
    ...
    {
      application_id: 'MS-006',
      project_id: 'p-000',
      sample_name: '外墙保温板',
      material_name: '外墙保温板',
      material_type: 'material',
      sample_date: '2026-08-01',
      spec: '岩棉板 80mm；导热系数≤0.040W/(m·K)；憎水率≥98%。',
      brand_ledger_id: 'BL-008',
      brand_name: '东方雨虹',
      manufacturer: '北京东方雨虹防水技术股份有限公司',
      ledger_material_name: '防水卷材',
      ...
      use_part_wbs_id: '',
      use_part: '外墙保温层',
      location_ids: ['loc-facade'],
      indicator_desc: '岩棉板 80mm；导热系数≤0.040W/(m·K)；憎水率≥98%。',
      sample_photos: [{ name: '保温板样板.jpg', url: '#' }],
      effect_images: [{ name: '保温板样板.jpg', url: '#' }],
      sign_files: [{ name: '材料设备送样定板报审签字.pdf', url: '#' }],
      approval_files: [{ name: '材料设备送样定板报审签字.pdf', url: '#' }],
      certificate_files: [{ name: '保温板出厂质量证明.pdf', url: '#' }],
      status: 'rejected',
      current_node: 'none',
      applicant_name: '施工-王工',
      submit_time: '2026-08-02 09:00:00',
      finish_time: '2026-08-03 11:00:00',
    ...
    {
      application_id: 'MS-007',
      project_id: 'p-000',
      sample_name: '外墙保温板',
      material_name: '外墙保温板',
      material_type: 'material',
      sample_date: '2026-08-05',
      spec: '岩棉板 80mm；导热系数≤0.040W/(m·K)；憎水率≥98%；已按驳回意见补全燃烧性能说明。',
      brand_ledger_id: 'BL-008',
      brand_name: '东方雨虹',
      manufacturer: '北京东方雨虹防水技术股份有限公司',
      ledger_material_name: '防水卷材',
      ...
      location_ids: ['loc-facade'],
      indicator_desc:
        '岩棉板 80mm；导热系数≤0.040W/(m·K)；憎水率≥98%；已按驳回意见补全燃烧性能说明。',
      sample_photos: [{ name: '保温板样板-补正.jpg', url: '#' }],
      effect_images: [{ name: '保温板样板-补正.jpg', url: '#' }],
      sign_files: [{ name: '材料设备送样定板报审签字.pdf', url: '#' }],
      approval_files: [{ name: '材料设备送样定板报审签字.pdf', url: '#' }],
      certificate_files: [{ name: '保温板出厂质量证明.pdf', url: '#' }],
      copy_from_application_id: 'MS-006',
      status: 'in_approval',
      current_node: 'supervisor',
      applicant_name: '施工-王工',
      submit_time: '2026-08-05 10:00:00',
      finish_time: '',
      remark: '演示：从已驳回单 MS-006 重新报审',
      supervisor_approver_user_id: 'u-jl-01',
      supervisor_approver_name: '李总监',
      pm_approver_user_id: 'u-pm-01',
      pm_approver_name: '王建国',
  ...
  processes: [
    ...
    {
      application_id: 'PS-004',
      project_id: 'p-000',
      process_name: '钢结构焊接样板',
      use_part: 'T2航站楼钢结构单位工程',
      location_id: 'wn-unit-1',
      location_ids: ['wn-unit-1'],
      briefing_content: '焊缝外观、探伤比例、焊材保管要求。',
      photo_files: ['钢结构焊接-正面.jpg', '钢结构焊接-节点.jpg'],
      video_files: [],
      media_files: [
        { name: '钢结构焊接-正面.jpg', kind: 'image' },
        { name: '钢结构焊接-节点.jpg', kind: 'image' },
      ],
      doc_files: ['钢结构焊接样板说明.pdf'],
      status: 'approved',
      current_node: 'none',
      applicant_name: '施工-李工',
      submit_time: '2026-07-15 09:00:00',
      finish_time: '2026-07-16 10:00:00',
      remark: '',
      supervisor_approver_user_id: 'u-jl-01',
      supervisor_approver_name: '李总监',
    },
    {
      application_id: 'PS-005',
      project_id: 'p-000',
      process_name: '幕墙隐框安装样板',
      use_part: 'T2航站楼幕墙单位工程',
      location_id: 'wn-unit-1',
      location_ids: ['wn-unit-1'],
      briefing_content: '密封胶注胶顺序、板块平整度、排水孔设置。',
      photo_files: ['幕墙样板.jpg'],
      video_files: ['幕墙交底.mp4'],
      media_files: [
        { name: '幕墙样板.jpg', kind: 'image' },
        { name: '幕墙交底.mp4', kind: 'video' },
      ],
      doc_files: ['幕墙样板说明.pdf'],
      status: 'in_approval',
      current_node: 'supervisor',
      applicant_name: '施工-王工',
      submit_time: '2026-08-06 09:30:00',
      finish_time: '',
      remark: '',
      supervisor_approver_user_id: 'u-jl-01',
      supervisor_approver_name: '李总监',
    ...
    {
      application_id: 'PS-006',
      project_id: 'p-000',
      process_name: '地坪环氧涂装样板',
      use_part: '地下室地坪',
      location_id: 'wn-unit-1',
      location_ids: ['wn-unit-1'],
      briefing_content: '基层含水率、涂层厚度、防滑骨料撒布。',
      photo_files: ['地坪样板.jpg'],
      video_files: [],
      media_files: [{ name: '地坪样板.jpg', kind: 'image' }],
      doc_files: [],
      status: 'rejected',
      current_node: 'none',
      applicant_name: '施工-李工',
      submit_time: '2026-08-01 14:00:00',
      finish_time: '2026-08-02 10:00:00',
      remark: '演示：已驳回留档，可重新申报',
      supervisor_approver_user_id: 'u-jl-01',
      supervisor_approver_name: '李总监',
    },
    {
      application_id: 'PS-007',
      project_id: 'p-000',
      process_name: '地坪环氧涂装样板',
      use_part: '地下室地坪',
      location_id: 'wn-unit-1',
      location_ids: ['wn-unit-1'],
      briefing_content: '基层含水率、涂层厚度、防滑骨料撒布；已按驳回意见补充测厚记录照片。',
      photo_files: ['地坪样板-补正.jpg', '测厚记录.jpg'],
      video_files: [],
      media_files: [
        { name: '地坪样板-补正.jpg', kind: 'image' },
        { name: '测厚记录.jpg', kind: 'image' },
      ],
      doc_files: ['地坪样板说明-补正.pdf'],
      copy_from_application_id: 'PS-006',
      status: 'in_approval',
      current_node: 'supervisor',
      applicant_name: '施工-李工',
      submit_time: '2026-08-04 09:00:00',
      finish_time: '',
      remark: '演示：从已驳回单 PS-006 重新报审',
      supervisor_approver_user_id: 'u-jl-01',
      supervisor_approver_name: '李总监',
    },
    {
      application_id: 'PS-009',
      project_id: 'p-000',
      process_name: '吊顶龙骨安装样板',
      use_part: '商业区吊顶',
      location_id: 'wn-unit-1',
      location_ids: ['wn-unit-1'],
      briefing_content: '龙骨间距、吊杆锚固、平整度控制。',
      photo_files: ['吊顶样板.jpg'],
      video_files: [],
      media_files: [{ name: '吊顶样板.jpg', kind: 'image' }],
      doc_files: [],
      status: 'rejected',
      current_node: 'none',
      applicant_name: '施工-王工',
      submit_time: '2026-08-03 10:00:00',
      finish_time: '2026-08-03 16:00:00',
      remark: '演示：已驳回留档，可重新申报',
      supervisor_approver_user_id: 'u-jl-01',
      supervisor_approver_name: '李总监',
    },
    {
      application_id: 'PS-008',
      project_id: 'p-000',
      process_name: '吊顶龙骨安装样板',
      use_part: '商业区吊顶',
      location_id: 'wn-unit-1',
      location_ids: ['wn-unit-1'],
      briefing_content: '龙骨间距、吊杆锚固、平整度控制；已按驳回意见补充吊杆锚固照片。',
      photo_files: ['吊顶样板-补正.jpg', '吊杆锚固.jpg'],
      video_files: [],
      media_files: [
        { name: '吊顶样板-补正.jpg', kind: 'image' },
        { name: '吊杆锚固.jpg', kind: 'image' },
      ],
      doc_files: ['吊顶样板说明.pdf'],
      copy_from_application_id: 'PS-009',
      status: 'in_approval',
      current_node: 'supervisor',
      applicant_name: '施工-王工',
      submit_time: '2026-08-05 15:00:00',
      finish_time: '',
      remark: '演示：从已驳回单 PS-009 重新报审',
      supervisor_approver_user_id: 'u-jl-01',
      supervisor_approver_name: '李总监',
    },
  ],
  approvals: [
    ...
    },
    {
      ...
      node_code: 'applicant',
      action: 'submit',
      opinion: '从 MS-004 重新申报',
      operator_name: '施工-李工',
      operate_time: '2026-07-22 10:30:00',
    },
    {
      record_id: 'AR-010',
      biz_type: 'material',
      ...
      node_code: 'supervisor',
      action: 'reject',
      opinion: '燃烧性能说明不足，请补充后重新申报',
      operator_name: '李总监',
      operate_time: '2026-08-03 11:00:00',
    },
    {
      record_id: 'AR-011',
      biz_type: 'material',
      ...
      node_code: 'applicant',
      action: 'submit',
      opinion: '从 MS-006 重新申报',
      operator_name: '施工-王工',
      operate_time: '2026-08-05 10:00:00',
    },
    {
      record_id: 'AR-012',
      biz_type: 'process',
      ...
      opinion: '直接提交',
      operator_name: '施工-李工',
      operate_time: '2026-07-15 09:00:00',
    },
    {
      record_id: 'AR-013',
      biz_type: 'process',
      ...
      opinion: '同意样板',
      operator_name: '李总监',
      operate_time: '2026-07-16 10:00:00',
    },
    {
      record_id: 'AR-014',
      biz_type: 'process',
      ...
      opinion: '直接提交',
      operator_name: '施工-王工',
      operate_time: '2026-08-06 09:30:00',
    },
    {
      record_id: 'AR-015',
      biz_type: 'process',
      ...
      node_code: 'supervisor',
      action: 'reject',
      opinion: '测厚记录缺失，请补充后重新申报',
      operator_name: '李总监',
      operate_time: '2026-08-02 10:00:00',
    },
    {
      record_id: 'AR-016',
      biz_type: 'process',
      ...
      node_code: 'applicant',
      action: 'submit',
      opinion: '从 PS-006 重新申报',
      operator_name: '施工-李工',
      operate_time: '2026-08-04 09:00:00',
    },
    {
      record_id: 'AR-017',
      biz_type: 'process',
      ...
      node_code: 'supervisor',
      action: 'reject',
      opinion: '吊杆锚固影像不足，请补充后重新申报',
      operator_name: '李总监',
      operate_time: '2026-08-03 16:00:00',
    },
    {
      record_id: 'AR-018',
      biz_type: 'process',
      ...
      node_code: 'applicant',
      action: 'submit',
      opinion: '从 PS-009 重新申报',
      operator_name: '施工-王工',
      operate_time: '2026-08-05 15:00:00',
    },
  ],
})
...
export function submitMaterialApp(payload) {
  ...
  upsertSampleStarted('material', app)
  return { ok: true, data: app }
}
export function submitProcessApp(payload) {
  ...
  upsertSampleStarted('process', app)
  return { ok: true, data: app }
}
...
function seedOpenSampleTodos() {
  for (const app of store.materials) {
    if (app.status !== 'in_approval') continue
    if (app.current_node === 'supervisor') {
      createSampleSupervisorTodo(buildTodoPayload('material', app))
    } else if (app.current_node === 'pm') {
      createSamplePmTodo(buildTodoPayload('material', app))
    }
  }
  for (const app of store.processes) {
    if (app.status !== 'in_approval') continue
    createSampleSupervisorTodo(buildTodoPayload('process', app))
  }
}
...
seedOpenSampleTodos()
seedSampleStartedFromApps(store.materials, store.processes)
seedSampleDoneFromApps(store.materials, store.processes)
